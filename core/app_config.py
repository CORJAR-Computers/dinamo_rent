...
class AppConfig:
    ...
    def _find_config_file(self, config_path: str = None) -> str:
        ...
        raise FileNotFoundError(
            ...
            "Copiar config.ini.example a config.ini y configurar."
        )
    ...
    def _validate_config(self) -> None:
        ...
        for section in required_sections:
            if not self._config.has_section(section):
                raise ValueError(
                    f"Sección requerida no encontrada en config.ini: [{section}]"
                )
    ...
    def get_security_config(self) -> dict:
        ...
        return {
            ...
            'max_login_attempts_in_window': self.getint('security', 'max_login_attempts_in_window', 10),
        }
