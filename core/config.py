...
# ─── Combos estáticos ────────────────────────────────────────────────────────
TIPOS_AUTO          = _cfg.getlist("business", "tipos_auto", ["Automóvil", "Camioneta", "Van", "Lujo", "Moto"])
TIPOS_TRANSMISION   = _cfg.getlist("business", "tipos_transmision", ["Automática", "Mecánica"])
TIPOS_COMBUSTIBLE   = _cfg.getlist("business", "tipos_combustible", ["Gasolina", "Diesel", "Híbrido", "Eléctrico", "Gas"])
ESTADOS_AUTO        = _cfg.getlist("business", "estados_auto", ["Disponible", "Rentado", "Mantenimiento", "Vendido", "Baja"])
TIPOS_ADQUISICION   = _cfg.getlist("business", "tipos_adquisicion", ["Propio", "Leasing", "Subarrendado"])
TIPOS_DOC           = _cfg.getlist("business", "tipos_doc", ["Cédula", "Pasaporte", "Cédula Extranjería", "NIT", "Licencia USA"])
ESTADOS_CLIENTE     = _cfg.getlist("business", "estados_cliente", ["Activo", "Inactivo", "Lista Negra", "VIP"])
NIVEL_TANQUE        = _cfg.getlist("business", "nivel_tanque", ["Lleno", "3/4", "1/2", "1/4", "Reserva"])
TIPOS_MANTENIMIENTO = _cfg.getlist("business", "tipos_mantenimiento", [
    "Cambio Aceite", "Frenos", "Llantas", "Batería",
    "Tecno-Mecánica", "Lavado General", "Reparación Mecánica", "Otro"
])
PAISES_DEFECTO      = _cfg.getlist("business", "paises_defecto", [
    "Colombia", "México", "Estados Unidos", "España", "Perú",
    "Argentina", "Chile", "Ecuador", "Panamá", "Costa Rica"
])
