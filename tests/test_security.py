...
class TestSessionManager:
    ...
    def test_create_retorna_token(self):
        ...
        sid = SessionManager.create(
            user_id=1, username="admin", role="Administrador", nombre="Admin"
        )
    ...
    def test_destroy_elimina_sesion(self, patch_time):
        ...
        sid = SessionManager.create(user_id=1, username="admin", role="Admin", nombre="Admin")
    ...
    def test_purge_expired_retorna_cantidad(self, patch_time):
        ...
        _s2 = SessionManager.create(user_id=2, username="b", role="R", nombre="B")
        patch_time[0] += 3601
    ...
    def test_multiple_sesiones_independientes(self, patch_time):
        ...
        s1 = SessionManager.create(user_id=1, username="alice", role="Admin", nombre="Alice")
        s2 = SessionManager.create(user_id=2, username="bob", role="Operador", nombre="Bob")
