...
from views.theme_colors import (
    ...
    BANNER_HEIGHT as _RENTAS_WIDGET_BANNER_HEIGHT,
    BANNER_MARGINS as _RENTAS_WIDGET_BANNER_MARGINS,
    BANNER_SPACING as _RENTAS_WIDGET_BANNER_SPACING,
    ICO_SIZE as _RENTAS_WIDGET_ICO_SIZE,
